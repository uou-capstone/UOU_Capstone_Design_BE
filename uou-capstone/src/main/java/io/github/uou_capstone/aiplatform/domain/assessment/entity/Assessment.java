...
public class Assessment extends BaseTimeEntity {
    ...
    private ExamSession examSession;  // v2: ExamSession 참조 (NULL 허용)

    @OneToMany(mappedBy = "assessment", cascade = CascadeType.ALL, orphanRemoval = true)
    private Set<io.github.uou_capstone.aiplatform.domain.exam.entity.ExamQuestion> questions = new HashSet<>();  // v2: ExamQuestion 사용
