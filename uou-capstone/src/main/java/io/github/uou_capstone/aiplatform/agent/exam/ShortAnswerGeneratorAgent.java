 ...
 */
@Slf4j
public class ShortAnswerGeneratorAgent extends AbstractAgent {

    public ShortAnswerGeneratorAgent(WebClient aiServiceWebClient, ObjectMapper objectMapper, AgentPerformanceLogger performanceLogger) {
        super(aiServiceWebClient, objectMapper, performanceLogger, "ShortAnswerGeneratorAgent");
    }

    @Override
    protected String getEndpoint() {
        return "/api/test-gen/short-answer";
    }
     ...
     * @return 생성된 단답형/서술형 문제 리스트
     */
    public List<ShortAnswerProblemDto> generateShortAnswerProblems(
        ...
        AgentRequest request = new SimpleAgentRequest("Generate short-answer problems", context);
