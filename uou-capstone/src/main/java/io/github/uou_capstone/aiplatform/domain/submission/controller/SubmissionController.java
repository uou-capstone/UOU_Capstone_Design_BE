package io.github.uou_capstone.aiplatform.domain.submission.controller;
...
import io.github.uou_capstone.aiplatform.domain.submission.service.SubmissionService;
...
public class SubmissionController {
    ...
    @Operation(summary = "제출 결과 상세 조회", description = "학생이 자신이 제출한 답안의 상세 내용을 조회합니다.")
