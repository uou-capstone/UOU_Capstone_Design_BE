...
/**
 * Evaluator Agent
 * 토론형 시험 Phase 2에서 사용자 입력의 논리적 품질을 평가
 */
@Slf4j
public class EvaluatorAgent extends AbstractAgent {

    public EvaluatorAgent(WebClient aiServiceWebClient, ObjectMapper objectMapper, AgentPerformanceLogger performanceLogger) {
        super(aiServiceWebClient, objectMapper, performanceLogger, "EvaluatorAgent");
    }

    @Override
    protected String getEndpoint() {
        return "/api/test-gen/debate/evaluator";
    }
