...
public class StudentAnswerResponseDto {
    ...
    private final ExamType questionType;  // v2: ExamType 사용
    ...
    public StudentAnswerResponseDto(StudentAnswer answer) {
        ...
        this.questionText = answer.getQuestion().getQuestionContent();  // v2: getText() → getQuestionContent()
        this.questionType = answer.getQuestion().getExamType();  // v2: getType() → getExamType()
        // choiceOption 필드를 사용
